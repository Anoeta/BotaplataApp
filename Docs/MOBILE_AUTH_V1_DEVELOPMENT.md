...
- Development utilise `http://192.168.1.47:31119` uniquement dans la configuration Debug locale.
- TestFlight et Production lisent `BOTAPLATA_API_BASE_URL` depuis l'Info.plist/build settings et n'ont aucun fallback vers l'adresse locale.

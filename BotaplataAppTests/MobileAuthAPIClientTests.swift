...
final class MobileAuthAPIClientTests: XCTestCase {
    ...
    func testVerifyRefreshLogoutAndDevices() async throws {
        ...
        let repo = RemoteAuthenticationRepository(client: makeClient { request in
            ...
            if request.httpMethod == "GET" { XCTAssertEqual(request.value(forHTTPHeaderField: "Authorization"), "Bearer access-rotated"); return Self.response(#"{"ok":true,"version":"mobile_v1","data":{"devices":[{"id":"dev-1","name":"iPhone","model":"iPhone","os_version":"26.5","app_version":"1.0","locale":"fr-FR","created_at":"2026-07-14T10:00:00Z","last_seen_at":null,"last_authenticated_at":"2026-07-14T10:00:00Z","is_current":true,"is_revoked":false}],"current_device_id":"dev-1"},"error":null,"meta":{"request_id":"req_devices","server_time":"2026-07-14T10:00:00Z"},"warnings":[]}"#) }
